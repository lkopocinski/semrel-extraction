from .gen_negative_substituted import substitute_brand, substitute_product


def test_substitute_brand():
    brand = 'Full brand name'
    brand_idx = 2
    brand_ctx = ['This', 'is', 'BRAND NAME', 'and', 'it', 'is', 'awesome']

    product_idx = 3
    product_ctx = ['I', 'love', 'an', 'Excellent product', 'very', 'much']

    actual_idx_brand, actual_ctx_brand, actual_idx_product, actual_ctx_product = substitute_brand(
        brand,
        brand_idx,
        brand_ctx,
        product_idx,
...
def test_substitute_product():
    brand_idx = 2
    brand_ctx = ['This', 'is', 'Full brand name', 'and', 'it', 'is', 'awesome']

    product = 'Excellent product'
    product_idx = 3
    product_ctx = ['I', 'love', 'an', 'PRODUCT', 'very', 'much']

    actual_idx_brand, actual_ctx_brand, actual_idx_product, actual_ctx_product = substitute_product(
        product,
        brand_idx,
        brand_ctx,
        product_idx,
