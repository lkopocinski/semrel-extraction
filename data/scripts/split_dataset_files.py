...
def main(argv=None):
    ...
    save_list(f'{args.output_directory}/train_files_{args.prefix}.txt', train)
    save_list(f'{args.output_directory}/valid_files_{args.prefix}.txt', valid)
    save_list(f'{args.output_directory}/test_files_{args.prefix}.txt', test)
